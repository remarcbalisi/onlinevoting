...
urlpatterns = [
    ...
    url(r'^onlinevoting/deleteelection/(?P<election_pk>[0-9]+)/$', views.election_delete, name='election_delete'),
    ...
    url(r'^onlinevoting/deleteuser/(?P<user_pk>[0-9]+)/$', views.user_delete, name='user_delete'),
    url(r'^onlinevoting/viewcandidate/profile/(?P<profile_pk>[0-9]+)/$', views.profile, name='profile'),
    url(r'^onlinevoting/candidateupdate/(?P<candidate_pk>[0-9]+)/$', views.candidate_update, name='candidate_update'),
]